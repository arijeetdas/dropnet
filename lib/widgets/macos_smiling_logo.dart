...
class MacOSSmilingLogo extends StatelessWidget {
  const MacOSSmilingLogo({
    super.key,
    this.size,
    this.color,
  });
...
''';
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveColor = color ?? iconTheme.color ?? Theme.of(context).colorScheme.onSurface;

    // Apply a scale factor of 0.8 (20% safety margin) so it matches the visual weight
    // of other circular/square icons and doesn't clip or look too bulky.
    final scaledSize = effectiveSize * 0.8;
